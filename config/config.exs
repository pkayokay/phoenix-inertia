...
config :phoenix_inertia,
  ecto_repos: [PhoenixInertia.Repo],
  generators: [timestamp_type: :utc_datetime]

# Configures the endpoint
config :phoenix_inertia, PhoenixInertiaWeb.Endpoint,
  url: [host: "localhost"],
  adapter: Bandit.PhoenixAdapter,
  render_errors: [
    formats: [html: PhoenixInertiaWeb.ErrorHTML, json: PhoenixInertiaWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: PhoenixInertia.PubSub,
  live_view: [signing_salt: "SHz0BBM8"]
...
config :phoenix_inertia, PhoenixInertia.Mailer, adapter: Swoosh.Adapters.Local

# Configure esbuild (the version is required)
config :esbuild,
  version: "0.21.5",
  phoenix_inertia: [
    args: ~w(js/app.jsx js/dead_app.js --bundle --target=es2020 --outdir=../priv/static/assets --external:/fonts/* --external:/images/*),
...
config :inertia,
  ...
  endpoint: PhoenixInertiaWeb.Endpoint,
